...
public class SQL {
    ...
    * 
    */
	public SQL(final boolean reload) {
			this.createTables(reload);
			this.loadData();
    ...
    * 
    */
	private void createTables(final boolean reload) {
		this.alterTables(reload); {
    ...
    * 
    */
	private void alterTables(final boolean reload) {
		if (!reload) {
